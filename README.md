# ALIAS — Handle Catalogue

Universal username catalogue (rarity + live availability). PlayStation is live;
Steam / Xbox / Discord / Twitch are stubbed in the platform picker.

Self-contained `index.html` — no server required for browsing. Live checks need
`server.py` or the hosted mirror.
...
- Public mirror: **https://aliashq.pages.dev** (Cloudflare Pages).
